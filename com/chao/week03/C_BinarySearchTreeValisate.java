...
public class C_BinarySearchTreeValisate {
     ...
     * @return
     */
    public boolean helper (src.TreeNode node, Integer lower, Integer upper) {
        if (node == null) {
            return true;
        }
...
//        src.TreeNode root = new src.src.TreeNode(2);
//        src.TreeNode left = new src.src.TreeNode(1);
//        src.TreeNode right = new src.src.TreeNode(7);
//        root.left =left;
//        root.right =right;
