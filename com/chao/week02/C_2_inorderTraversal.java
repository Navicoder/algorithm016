...
public class C_2_inorderTraversal {
     ...
     * @return
     */
    public List<Integer> inorderTraversal (src.TreeNode root) {
        List<Integer> list = new ArrayList<>();
        deal(list,root);

        return list;
    }
    private void deal(List<Integer> list, src.TreeNode root) {
        if (root == null) {
            return;
        }
        deal(list,root.left);
     ...
     * @return
     */
    public List<Integer> inorderTraversal2 (src.TreeNode root) {
        List<Integer> list = new ArrayList<>();
     ...
     * @return
     */
    public List<Integer> inorderTraversal3 (src.TreeNode root) {
        List<Integer> list = new ArrayList<>();
        TreeNode pre = null;
        while (root != null){
